...
<div class="container px-2">
  <div class="navbar-brand">
    <RouterLink :to="{ name: 'notes'}" class="navbar-item is-size-4 is-family-monospace" href="https://bulma.io">
        NotesList
    </RouterLink>
  ...
  <div id="navbarBasicExample" class="navbar-menu" :class="{'is-active': showNavBarMenu}">
    <div class="navbar-start" v-if="authStore.user.uid">
      <button class="button is-info is-small mt-3 ml-3" @click.prevent="onLogout">Logout {{ authStore.user.email }}</button>
    </div>
